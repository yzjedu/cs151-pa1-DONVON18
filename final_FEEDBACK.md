...
| **-NO** | Input prompts were clear as to what type of thing you were being asked to enter        |
| **-NO** | The output was clear and easy to understand                                            |
...
- There is no reason to use while true in this algorithm. 
- The algorithm and the code doesn't resemble one another. 
- 
### PA Grade: M
